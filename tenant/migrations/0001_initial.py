...
import tenant.models.client_model
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paid_until', models.DateField(default=tenant.models.client_model.default_date)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street_address_extra', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('organization', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
